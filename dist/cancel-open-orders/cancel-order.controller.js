...
let CancelOrderController = class CancelOrderController {
    ...
    marketNewOrder(param) {
        return this.httpRequestService.httpRequest(param, const_1.CANCEL_ALL_ORDERS, const_1.DELETE);
    }
};
__decorate([
...
], CancelOrderController.prototype, "marketNewOrder", null);
CancelOrderController = __decorate([
    (0, common_1.Controller)('cancel-open-orders'),
...
//# sourceMappingURL=cancel-order.controller.js.map